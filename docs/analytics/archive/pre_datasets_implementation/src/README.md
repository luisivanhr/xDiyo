...
## Labels and next development stage
...
The full analytics suite passes **394 tests**, including 119 new label cases.
...
and explicit generic settlement. Identity metadata supports later assembly and
reporting; final X/y alignment is not implemented yet. Split lines, parlays and
bookmaker-specific settlement remain outside the current label contract.
