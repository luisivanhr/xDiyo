"""Multi-season discovery, independent concatenation and saved selections."""
...
def _publish(root, league, label, *, version='v1', extra=False):
...
def test_unavailable_requested_table_is_an_error(population):
    with pytest.raises(KeyError, match="unknown_table.*unavailable"):
        load_seasons(population, ['22_23', '23_24'], tables=['matches', 'unknown_table'])
