...
The label and assembly batches are implemented and verified, following league/LOO, explicit warm starts and rating transitions. The new splits/CV layer has passed runtime, real-data and documentation checks; final preservation audit is pending. Model adapters, reports, fold-aware state preparation and generic orchestration remain before the corner experiment. Pilot recipe selection, tuning and fitting remain deferred. Historical design material remains below and in the preserved archive.

## Splits and CV — implementation checked, 17 September 2026
...
All 632 analytics cases pass, including 142 new cases and the previous 490.
Four pinned Premier League/Bundesliga publications supply 1,372 matches and
2,744 team rows; 14 scheme/layout combinations reconcile 192,240 membership
positions and 41,160 reconstructed numeric cells. Ten guide examples, the
separate nine-cell notebook (five code cells), isolated imports from a
77-file wheel copy and all 27 LaTeX expressions pass. No implementation defect
or worker source edit was needed. Final preservation audit is pending.
...
splitting, training and reporting orchestration remain later work. (D)
...
**Current implementation direction:** loading, observed histories, features, league/LOO, explicit warm starts, result/statistic rating transitions, labels and dataset assembly are verified. Splits/CV now pass independent runtime and documentation checks. Fold-aware state preparation, model adapters, both reporter stages and generic orchestration remain before the corner experiment. Existing league/season and eventual Lasso/corner choices remain context; pilot recipe selection, tuning and fitting are deferred. (D)
