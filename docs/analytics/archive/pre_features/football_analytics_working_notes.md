...
These rows contain observed outcomes. Feature eligibility still needs historical
availability and cutoff rules; scheduled kickoff alone is insufficient. Lags,
rolling windows, model fitting and rating-state integration remain deferred.
