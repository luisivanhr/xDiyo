...
fitting policies belong to the future training runner. No model fitting or
...
assembly and splits to training-only transforms/model adapters and post-training
reports. Implemented pre-training reports consume the declared layout and metadata;
future post-training reporters add predictions and applicable model outputs.
