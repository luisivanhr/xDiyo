...
scheduled refitting and post-training reporters remain later work. Existing
...
scheduled refitting and post-training reports. Implemented pre-training reports
consume the declared layout and metadata; future post-training reporters add
predictions and applicable model outputs. Pilot recipe selection, tuning and
