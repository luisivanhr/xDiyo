...
types, row order and nulls. Those 55 loading cases remain in the current 83-test
suite, alongside 28 statistic-selection cases.
...
[eleven-cell notebook](notebooks/01_loader_walkthrough.ipynb) shows practical usage
...
No history builder, joins, feature construction or fitting was added.
