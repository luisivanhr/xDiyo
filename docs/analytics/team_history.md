...
This is a table of **observed outcomes**. The separate
[feature evaluator](features.md) now computes lags, rolling summaries, H2H and
context features using explicit eligibility rules. Cutoffs and availability
times are optional; default earlier finished kickoffs are a retrospective proxy,
not proof of exact result-completion/publication times. Model fitting remains
subsequent work.
