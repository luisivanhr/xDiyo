...
Pass the selection to [build_team_history](team_history.md) when you need two
team/opponent rows per match. That separate step reshapes observed values and
retains full UTC kickoff times; historical feature eligibility remains deferred.
